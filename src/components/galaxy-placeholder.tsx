...
export const GalaxyPlaceholder = ({ children }: GalaxyPlaceholderProps) => {
  return (
    <div className="relative w-full h-full overflow-hidden rounded-lg bg-gradient-to-b from-background to-secondary/30">
      {/* Starfield effect */}
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-foreground/5 rounded-full blur-3xl" />
